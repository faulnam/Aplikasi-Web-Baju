...
<body>
  ...
  <div class="container-fluid">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li>
              <a class="dropdown-item" href="logout.php" onclick="return confirm('Yakin akan logout?')">
    ...
    <div class=" container pt-3">
        <h3 class="mt-5 fw-bold text-dark">Riwayat Belanja 🛍️</h3>

        <div class="d-flex flex-wrap gap-4 mt-4 justify-content-start" id="load_produk">
        <?php foreach ($riwayat as $row){ ?>
            <div class="card shadow-sm border-0 rounded-4 overflow-hidden" style="width: 18rem; background: #f9f9f9;">
                <a href="../../Produk/detail_produk.php?id_produk=<?php echo $row['id_produk'] ?>" class="text-decoration-none text-dark"
                    data-bs-toggle="tooltip" data-bs-placement="top" title="Klik untuk lihat detail">
                    
                    <!-- Gambar Produk -->
                    <img src="../../img/<?php echo $row['gambar'] ?>" class="img-fluid" style="height: 250px; object-fit: cover;">

                    <!-- Konten Produk -->
                    <div class="card-body px-3">
                        <h5 class="fw-semibold mb-1"><?php echo $row['nama_produk'] ?></h5>
                        <p class="text-primary fw-bold mb-0">Rp <?php echo number_format($row['harga'], 2, ',', '.') ?></p>
                        <small class="text-muted d-block mt-1">Klik untuk detail produk</small>
                    </div>
                </a>
            </div>
        <?php } ?>
